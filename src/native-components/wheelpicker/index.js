...
const { Picker, StyleSheet, requireNativeComponent } = require('react-native');

const WheelPickerItem = require('./WheelPickerItem');
...
module.exports = Constants.isAndroid ? WheelPicker : Picker;
