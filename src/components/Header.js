...
class RNCHeaderAndroid extends React.Component {
...
class RNCHeaderIOS extends React.Component {
  static height: number;
  props: Props;
...
// const Header = Platform.OS === 'ios' ? RNCHeaderIOS : RNCHeaderAndroid;
const Header = RNCHeaderIOS;
